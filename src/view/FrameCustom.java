...
public class FrameCustom extends JPanel
{
    ...
    public FrameCustom()
    {
        ...
        // Navbar
        PanelSidebar navbar = new PanelSidebar();
        add(navbar.getPanel(), BorderLayout.WEST);
        ...
        JLabel rightLabel = new JLabel("Panel Derecho");
        ...
        gbc.weightx = 1.0; // Opcupar el 100% de width
